...
namespace Cnpscy\BaseSocialite\Providers;

use GuzzleHttp\Client;
use GuzzleHttp\ClientInterface;
use Cnpscy\BaseSocialite\AccessToken;
use Cnpscy\BaseSocialite\AccessTokenInterface;
use Cnpscy\BaseSocialite\AuthorizeFailedException;
use Cnpscy\BaseSocialite\InvalidStateException;
use Cnpscy\BaseSocialite\ProviderInterface;
...
abstract class AbstractProvider implements ProviderInterface
{
    ...
    /**
     * @var \Cnpscy\BaseSocialite\AccessTokenInterface
     */
     ...
     *
     * @param \Cnpscy\BaseSocialite\AccessTokenInterface $token
     *
     * @return array
     */
     ...
     * @param array $user
     *
     * @return \Cnpscy\BaseSocialite\User
     */
    ...
    /**
     * @param \Cnpscy\BaseSocialite\AccessTokenInterface $accessToken
     *
     * @return $this
     */
     ...
     * @param string $code
     *
     * @return \Cnpscy\BaseSocialite\AccessTokenInterface
     */
    public function getAccessToken($code)
    {
        ...
        $postKey = (1 === version_compare(ClientInterface::VERSION ?? ClientInterface::MAJOR_VERSION, '6')) ? 'form_params' : 'body';
